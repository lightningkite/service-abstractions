...
abstract class ConditionTests() {
    ...
    fun test_List_all_greaterThan() = runTest {
        val collection = database.collection<LargeTestModel>("LargeTestModel_test_List_all_gt")
...
//    }
    ...
    fun UUIUUID_gt_nullable() = runTest {
        val collection = database.collection<LargeTestModel>("UUIUUID_gt_nullable")
        val isNull = LargeTestModel(uuidNullable = null)
