...
include(":demo")
include(":embedding")
include(":embedding-bedrock")
include(":embedding-ollama")
include(":embedding-openai")
include(":embedding-test")
include(":email")
...
include(":files-test")
//include(":geocoding")
//include(":geocoding-google")
//include(":geocoding-local")
//include(":geocoding-nominatim")
//include(":geocoding-stadia")
//include(":geocoding-test")
include(":http-client")
