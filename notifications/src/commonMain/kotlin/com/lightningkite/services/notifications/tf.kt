 ...
 */
public fun TerraformNeed<NotificationService.Settings>.console(): TerraformServiceResult<NotificationService.Settings> = TerraformServiceResult(
    need = this,
    setting = "console://",
 ...
 */
public fun TerraformNeed<NotificationService.Settings>.test(): TerraformServiceResult<NotificationService.Settings> = TerraformServiceResult(
    need = this,
    setting = "test://",
    requireProviders = setOf(),
    content = buildJsonObject {}
