 ...
 * `true` and the row is included. Mirrors [PostgresNotInsideNullableTest], the sibling condition
 * type that already carried this null guard.
 */
class PostgresNotEqualNullableTest {
    companion object {
        @ClassRule
        @JvmField
