...
tasks.register<JavaExec>("runLiveTest") {
    description = "Run the Twilio live test demo"
    group = "verification"
    classpath = sourceSets["test"].runtimeClasspath
    mainClass.set("com.lightningkite.services.phonecall.twilio.TwilioPhoneCallServiceLiveTest")
}

tasks.register<JavaExec>("runLightningServerDemo") {
    description = "Run the Lightning Server phone demo with webhook handling"
    group = "verification"
    classpath = sourceSets["test"].runtimeClasspath
    mainClass.set("com.lightningkite.services.phonecall.twilio.TwilioLightningServerDemo")
