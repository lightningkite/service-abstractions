 ...
 * ```
 */
@JvmInline public value class TelemetryAttributes private constructor(public val map: Map<TelemetryKey<*>, Any>) {
...
public fun TelemetryAttributes(raw: Map<String, Any>): TelemetryAttributes =
