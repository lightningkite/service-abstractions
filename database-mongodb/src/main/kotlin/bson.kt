...
import com.lightningkite.serviceabstractions.database.TextIndex
import com.lightningkite.serviceabstractions.database.termShouldUseFuzzySearch
...
public fun <T> Condition<T>.bson(serializer: KSerializer<T>, atlasSearch: Boolean = false, context: SettingContext) = Document().also { dump(serializer, it, null, atlasSearch, context) }
