...
private val serializationOverrides = mapOf<SerialDescriptor, BsonConversion<*>>(
    ...
    LocalDate.serializer().descriptor to object: BsonConversion<LocalDate> {
        override fun toBson(value: LocalDate): BsonDateTime = BsonDateTime(value.atStartOfDayIn(TimeZone.UTC).toEpochMilliseconds())
    ...
    LocalDateTime.serializer().descriptor to object: BsonConversion<LocalDateTime> {
        override fun toBson(value: LocalDateTime): BsonDateTime = BsonDateTime(value.toInstant(TimeZone.UTC).toEpochMilliseconds())
    ...
    LocalTime.serializer().descriptor to object: BsonConversion<LocalTime> {
        override fun toBson(value: LocalTime): BsonDateTime = BsonDateTime(value.atDate(LocalDate.fromEpochDays(0)).toInstant(TimeZone.UTC).toEpochMilliseconds())
