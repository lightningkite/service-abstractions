...
fun KSerializer<*>.tryTypeParameterSerializers(): Array<KSerializer<*>>? =
...
@Suppress("UNCHECKED_CAST")
inline fun <reified T> SerializersModule.contextualSerializerIfHandled(): KSerializer<T> =
    contextualSerializerIfHandled(typeOf<T>()) as KSerializer<T>
...
@Suppress("UNCHECKED_CAST")
inline fun <reified T> SerializersModule.serializerPreferContextual(): KSerializer<T> =
    serializerPreferContextual(typeOf<T>()) as KSerializer<T>
...
@Suppress("UNCHECKED_CAST")
inline fun <reified T> SerializersModule.getContextual(): KSerializer<T>? =
    getContextual(typeOf<T>()) as KSerializer<T>?
