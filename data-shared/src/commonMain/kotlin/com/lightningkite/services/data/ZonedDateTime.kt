...
public inline fun LocalDateTime.atZone(zone: TimeZone): ZonedDateTime = ZonedDateTime(this, zone)

@Suppress("NOTHING_TO_INLINE")
public inline fun Instant.atZone(zone: TimeZone): ZonedDateTime = ZonedDateTime(this.toLocalDateTime(zone), zone)

public fun Clock.nowLocal(): ZonedDateTime =
    ZonedDateTime(now().toLocalDateTime(TimeZone.currentSystemDefault()), TimeZone.currentSystemDefault())
...
@Suppress("NOTHING_TO_INLINE")
public inline fun LocalDateTime.atOffset(offset: UtcOffset): OffsetDateTime = OffsetDateTime(this, offset)

@Suppress("NOTHING_TO_INLINE")
public inline fun Instant.atOffset(offset: UtcOffset): OffsetDateTime =
    OffsetDateTime(this.toLocalDateTime(FixedOffsetTimeZone(offset)), offset)
