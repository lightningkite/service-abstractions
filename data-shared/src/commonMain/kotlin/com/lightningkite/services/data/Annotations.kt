...
public annotation class CheckReturnValue
...
public annotation class ValidationAnnotation
...
public annotation class NaturalSort(val fields: Array<String>)
...
@Retention(AnnotationRetention.BINARY)
@Target(AnnotationTarget.CLASS)
public annotation class AdminSearchFields(val fields: Array<String>)
...
@Retention(AnnotationRetention.BINARY)
@Target(AnnotationTarget.CLASS)
public annotation class AdminTableColumns(val fields: Array<String>)
...
@Retention(AnnotationRetention.BINARY)
@Target(AnnotationTarget.CLASS)
public annotation class AdminTitleFields(val fields: Array<String>)
...
public annotation class AdminHidden()
...
@Retention(AnnotationRetention.BINARY)
@Target(AnnotationTarget.PROPERTY, AnnotationTarget.FIELD)
public annotation class AdminViewOnly()
...
@Retention(AnnotationRetention.BINARY)
@Target(AnnotationTarget.PROPERTY, AnnotationTarget.FIELD)
public annotation class UiWidget(val type: String)
...
@Retention(AnnotationRetention.BINARY)
@Target(AnnotationTarget.PROPERTY, AnnotationTarget.FIELD)
public annotation class JsonSchemaFormat(val format: String)
...
public annotation class IntegerRange(val min: Long, val max: Long)
...
@Target(AnnotationTarget.PROPERTY, AnnotationTarget.FIELD)
@ValidationAnnotation
public annotation class FloatRange(val min: Double, val max: Double)
...
@Target(AnnotationTarget.PROPERTY, AnnotationTarget.FIELD)
@ValidationAnnotation
public annotation class ExpectedPattern(val pattern: String)
...
public annotation class DisplayName(val text: String)
...
@Retention(AnnotationRetention.BINARY)
@Target(AnnotationTarget.CLASS, AnnotationTarget.PROPERTY, AnnotationTarget.FIELD)
public annotation class Hint(val text: String)
...
@Target(AnnotationTarget.PROPERTY, AnnotationTarget.FIELD)
@ValidationAnnotation
public annotation class MaxLength(val size: Int, val average: Int = -1)

@SerialInfo
@Retention(AnnotationRetention.BINARY)
@Target(AnnotationTarget.PROPERTY, AnnotationTarget.FIELD)
@ValidationAnnotation
public annotation class MaxSize(val size: Int, val average: Int = -1)

@SerialInfo
@Retention(AnnotationRetention.BINARY)
@Target(AnnotationTarget.PROPERTY, AnnotationTarget.FIELD)
public annotation class Denormalized(val calculationId: String = "")
...
@Retention(AnnotationRetention.BINARY)
@Target(AnnotationTarget.CLASS)
public annotation class GenerateDataClassPaths
...
@Retention(AnnotationRetention.BINARY)
@Target(AnnotationTarget.PROPERTY, AnnotationTarget.FIELD)
public annotation class MultipleReferences(
    val references: KClass<*>,
    val reverseName: String = "",
)
...
@Retention(AnnotationRetention.BINARY)
@Target(AnnotationTarget.PROPERTY, AnnotationTarget.FIELD)
public annotation class DoesNotNeedLabel
...
@Retention(AnnotationRetention.BINARY)
@Target(AnnotationTarget.PROPERTY, AnnotationTarget.FIELD)
public annotation class Sentence(val text: String)
...
@Retention(AnnotationRetention.BINARY)
@Target(AnnotationTarget.PROPERTY, AnnotationTarget.FIELD)
public annotation class Importance(val size: Int)

public enum class IndexUniqueness(public val isUnique: Boolean) {
    NotUnique(false),
    Unique(true),
...
@Retention(AnnotationRetention.BINARY)
@Target(AnnotationTarget.PROPERTY, AnnotationTarget.FIELD)
public annotation class Index(val unique: IndexUniqueness = IndexUniqueness.NotUnique, val name: String = "")
...
@Target(AnnotationTarget.CLASS)
@Repeatable
public annotation class IndexSet(
    val fields: Array<String>,
    val unique: IndexUniqueness = IndexUniqueness.NotUnique,
    val name: String = "",
)
...
@Retention(AnnotationRetention.BINARY)
@Target(AnnotationTarget.CLASS)
public annotation class TextIndex(val fields: Array<String>)
