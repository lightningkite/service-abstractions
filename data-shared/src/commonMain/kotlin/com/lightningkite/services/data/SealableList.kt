...
public class SealableList<E>(private val wraps: MutableList<E> = ArrayList()) : MutableList<E> by wraps {
    ...
    override fun clear(): Unit = checkSealed { clear() }
    override fun set(index: Int, element: E): E = checkSealed { set(index, element) }
    override fun add(index: Int, element: E): Unit = checkSealed { add(index, element) }
    ...
    override fun subList(fromIndex: Int, toIndex: Int): MutableList<E> =
        SealableList(wraps.subList(fromIndex, toIndex)).also { it.sealed = sealed }
