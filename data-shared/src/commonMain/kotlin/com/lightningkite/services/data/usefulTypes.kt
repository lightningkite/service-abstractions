...
public value class DataSize(public val bytes: Long) : Comparable<DataSize> {
    ...
    @Deprecated(
        "Prefer the precise measure inWholeKibibytes.  If you meant to use decimal units, be explicit about it.",
        ReplaceWith("inWholeKibibytes")
    )
    public val inWholeKilobytes: Long get() = inWholeKibibytes
    @Deprecated(
        "Prefer the precise measure inWholeMebibytes.  If you meant to use decimal units, be explicit about it.",
        ReplaceWith("inWholeMebibytes")
    )
    public val inWholeMegabytes: Long get() = inWholeMebibytes
    @Deprecated(
        "Prefer the precise measure inWholeGibibytes.  If you meant to use decimal units, be explicit about it.",
        ReplaceWith("inWholeGibibytes")
    )
    public val inWholeGigabytes: Long get() = inWholeGibibytes
    @Deprecated(
        "Prefer the precise measure inWholeTebibytes.  If you meant to use decimal units, be explicit about it.",
        ReplaceWith("inWholeTebibytes")
    )
    public val inWholeTerabytes: Long get() = inWholeTebibytes
    @Deprecated(
        "Prefer the precise measure kibibytes.  If you meant to use decimal units, be explicit about it.",
        ReplaceWith("kibibytes")
    )
    public val kilobytes: Double get() = kibibytes
    @Deprecated(
        "Prefer the precise measure mebibytes.  If you meant to use decimal units, be explicit about it.",
        ReplaceWith("mebibytes")
    )
    public val megabytes: Double get() = mebibytes
    @Deprecated(
        "Prefer the precise measure gibibytes.  If you meant to use decimal units, be explicit about it.",
        ReplaceWith("gibibytes")
    )
    public val gigabytes: Double get() = gibibytes
    @Deprecated(
        "Prefer the precise measure tebibytes.  If you meant to use decimal units, be explicit about it.",
        ReplaceWith("tebibytes")
    )
    public val terabytes: Double get() = tebibytes
    ...
    public companion object {
        ...
        @Deprecated(
            "Prefer the precise measure tebibytes.  If you meant to use decimal units, be explicit about it.",
            ReplaceWith("kilobytes")
        )
        public val Int.kilobytes: DataSize get() = kibibytes
        @Deprecated(
            "Prefer the precise measure tebibytes.  If you meant to use decimal units, be explicit about it.",
            ReplaceWith("megabytes")
        )
        public val Int.megabytes: DataSize get() = mebibytes
        @Deprecated(
            "Prefer the precise measure tebibytes.  If you meant to use decimal units, be explicit about it.",
            ReplaceWith("gigabytes")
        )
        public val Int.gigabytes: DataSize get() = gibibytes
        @Deprecated(
            "Prefer the precise measure tebibytes.  If you meant to use decimal units, be explicit about it.",
            ReplaceWith("terabytes")
        )
        public val Int.terabytes: DataSize get() = tebibytes
        @Deprecated(
            "Prefer the precise measure tebibytes.  If you meant to use decimal units, be explicit about it.",
            ReplaceWith("kilobytes")
        )
        public val Long.kilobytes: DataSize get() = kibibytes
        @Deprecated(
            "Prefer the precise measure tebibytes.  If you meant to use decimal units, be explicit about it.",
            ReplaceWith("megabytes")
        )
        public val Long.megabytes: DataSize get() = mebibytes
        @Deprecated(
            "Prefer the precise measure tebibytes.  If you meant to use decimal units, be explicit about it.",
            ReplaceWith("gigabytes")
        )
        public val Long.gigabytes: DataSize get() = gibibytes
        @Deprecated(
            "Prefer the precise measure tebibytes.  If you meant to use decimal units, be explicit about it.",
            ReplaceWith("terabytes")
        )
        public val Long.terabytes: DataSize get() = tebibytes
        @Deprecated(
            "Prefer the precise measure tebibytes.  If you meant to use decimal units, be explicit about it.",
            ReplaceWith("kilobytes")
        )
        public val Double.kilobytes: DataSize get() = kibibytes
        @Deprecated(
            "Prefer the precise measure tebibytes.  If you meant to use decimal units, be explicit about it.",
            ReplaceWith("megabytes")
        )
        public val Double.megabytes: DataSize get() = mebibytes
        @Deprecated(
            "Prefer the precise measure tebibytes.  If you meant to use decimal units, be explicit about it.",
            ReplaceWith("gigabytes")
        )
        public val Double.gigabytes: DataSize get() = gibibytes
        @Deprecated(
            "Prefer the precise measure tebibytes.  If you meant to use decimal units, be explicit about it.",
            ReplaceWith("terabytes")
        )
        public val Double.terabytes: DataSize get() = tebibytes
...
public value class Acceleration(public val metersPerSecondPerSecond: Double) : Comparable<Acceleration> {
    public override fun compareTo(other: Acceleration): Int =
        this.metersPerSecondPerSecond.compareTo(other.metersPerSecondPerSecond)
    ...
    public operator fun plus(other: Acceleration): Acceleration =
        Acceleration(metersPerSecondPerSecond + other.metersPerSecondPerSecond)
...
public value class RelativeTemperature(public val celsius: Double) : Comparable<Temperature> {
    ...
    public operator fun plus(other: RelativeTemperature): RelativeTemperature =
        RelativeTemperature(celsius + other.celsius)

    public operator fun minus(other: RelativeTemperature): RelativeTemperature =
        RelativeTemperature(celsius - other.celsius)
...
public operator fun Acceleration.times(other: Duration): Speed =
    Speed(metersPerSecond = this.metersPerSecondPerSecond * other.toDouble(DurationUnit.SECONDS))

public operator fun Acceleration.times(other: Mass): Force =
    Force(newtons = this.metersPerSecondPerSecond * other.kilograms)
...
public operator fun Duration.times(other: Acceleration): Speed =
    Speed(metersPerSecond = this.toDouble(DurationUnit.SECONDS) * other.metersPerSecondPerSecond)

public operator fun Duration.times(other: Power): Energy =
    Energy(joules = this.toDouble(DurationUnit.SECONDS) * other.watts)

public operator fun Duration.times(other: Speed): Length =
    Length(meters = this.toDouble(DurationUnit.SECONDS) * other.metersPerSecond)

public operator fun Energy.div(other: Duration): Power =
    Power(watts = this.joules / other.toDouble(DurationUnit.SECONDS))
...
public operator fun Force.div(other: Acceleration): Mass =
    Mass(kilograms = this.newtons / other.metersPerSecondPerSecond)

public operator fun Force.div(other: Area): Pressure = Pressure(pascals = this.newtons / other.squareMeters)
public operator fun Force.div(other: Mass): Acceleration =
    Acceleration(metersPerSecondPerSecond = this.newtons / other.kilograms)
...
public operator fun Length.div(other: Duration): Speed =
    Speed(metersPerSecond = this.meters / other.toDouble(DurationUnit.SECONDS))
...
public operator fun Mass.times(other: Acceleration): Force =
    Force(newtons = this.kilograms * other.metersPerSecondPerSecond)
...
public operator fun Power.times(other: Duration): Energy =
    Energy(joules = this.watts * other.toDouble(DurationUnit.SECONDS))
...
public operator fun Speed.div(other: Acceleration): Duration =
    (this.metersPerSecond / other.metersPerSecondPerSecond).seconds

public operator fun Speed.div(other: Duration): Acceleration =
    Acceleration(metersPerSecondPerSecond = this.metersPerSecond / other.toDouble(DurationUnit.SECONDS))

public operator fun Speed.times(other: Duration): Length =
    Length(meters = this.metersPerSecond * other.toDouble(DurationUnit.SECONDS))
