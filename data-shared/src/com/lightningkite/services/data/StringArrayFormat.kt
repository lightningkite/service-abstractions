...
public class StringArrayFormat(override val serializersModule: SerializersModule) : StringFormat {
    ...
    private inner class DataOutputEncoder(val output: (String) -> Unit) : AbstractEncoder() {
        ...
        override fun encodeEnum(enumDescriptor: SerialDescriptor, index: Int) {
            output(enumDescriptor.getElementName(index))
        }
    ...
    @OptIn(ExperimentalSerializationApi::class)
    private inner class DataInputDecoder(
        val input: () -> String,
