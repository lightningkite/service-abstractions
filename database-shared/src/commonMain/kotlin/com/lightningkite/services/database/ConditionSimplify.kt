...
public fun <T> Condition<T>.simplify(): Condition<T> {
    return when (this) {
        is Condition.And -> {
...
private fun <T> reduceAnd(a: Condition<T>, b: Condition<T>): Condition<T> {
    return when (a) {
        ...
        is Condition.GreaterThan -> when (b) {
            ...
            is Condition.LessThan -> if (a.value.let { it as Comparable<Any?> } >= b.value.let { it as Comparable<Any?> }) Condition.Never else Condition.And(
                listOf(a, b)
            )

            is Condition.LessThanOrEqual -> if (a.value.let { it as Comparable<Any?> } >= b.value.let { it as Comparable<Any?> }) Condition.Never else Condition.And(
                listOf(a, b)
            )
...
private fun <T> reduceOr(a: Condition<T>, b: Condition<T>): Condition<T> {
    return when (a) {
        ...
        is Condition.Equal -> when (b) {
            ...
            is Condition.GreaterThan -> if (a.value.let { it as Comparable<Any?> } > b.value.let { it as Comparable<Any?> }) b else Condition.Or(
                listOf(a, b)
            )

            is Condition.LessThan -> if (a.value.let { it as Comparable<Any?> } < b.value.let { it as Comparable<Any?> }) b else Condition.Or(
                listOf(a, b)
            )

            is Condition.GreaterThanOrEqual -> if (a.value.let { it as Comparable<Any?> } >= b.value.let { it as Comparable<Any?> }) b else Condition.Or(
                listOf(a, b)
            )

            is Condition.LessThanOrEqual -> if (a.value.let { it as Comparable<Any?> } <= b.value.let { it as Comparable<Any?> }) b else Condition.Or(
                listOf(a, b)
            )
