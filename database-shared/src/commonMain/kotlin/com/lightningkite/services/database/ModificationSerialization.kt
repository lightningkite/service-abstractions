...
internal object ModificationAppendStringSerializer : WrappingSerializer<Modification.AppendString, String>("AppendString") {
...
internal class ModificationAppendRawStringSerializer<T : IsRawString> :
    WrappingSerializer<Modification.AppendRawString<T>, String>("AppendString") {
    override fun getDeferred(): KSerializer<String> = String.serializer()
