...
internal object DefaultSerializableAnnotationParsers {
    init {
        ...
        SerializableAnnotation.parser<MimeType>("com.lightningkite.services.data.MimeType") { SerializableAnnotation("com.lightningkite.services.data.MimeType", values = mapOf("whitelist" to SerializableAnnotationValue(it.whitelist), "blacklist" to SerializableAnnotationValue(it.blacklist), "maxSize" to SerializableAnnotationValue(it.maxSize))) }
