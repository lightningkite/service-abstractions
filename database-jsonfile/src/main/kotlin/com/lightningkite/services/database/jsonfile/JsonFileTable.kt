...
public class JsonFileTable<Model : Any>(
    ...
    override suspend fun find(
        ...
        val results = traced(
            operation = "find",
            extraBlock = {
                put(Database.TelemetryKeys.limit, limit.toLong())
                put(Database.TelemetryKeys.skip, skip.toLong())
            }
        ) { span ->
            val results = super.find(condition, orderBy, skip, limit, maxQueryMs).toList()
            span.enrich(TelemetryAttributes { put(Database.TelemetryKeys.resultCount, results.size.toLong()) })
            results
        }
    ...
    override suspend fun count(condition: Condition<Model>): Int = traced(
        ...
        span.enrich(TelemetryAttributes { put(Database.TelemetryKeys.count, result.toLong()) })
        result
    }
    ...
    override suspend fun <Key> groupCount(
        ...
        extraBlock = { put(Database.TelemetryKeys.groupBy, groupBy.toString()) }
    ) { span ->
        val result = super.groupCount(condition, groupBy)
        span.enrich(TelemetryAttributes { put(Database.TelemetryKeys.groups, result.size.toLong()) })
        result
    }
    ...
    override suspend fun <N : Number?> aggregate(
        ...
        operation = "aggregate",
        extraBlock = {
            put(Database.TelemetryKeys.aggregate, aggregate.toString())
            put(Database.TelemetryKeys.property, property.toString())
        }
    ) { span ->
    ...
    override suspend fun <N : Number?, Key> groupAggregate(
        ...
        extraBlock = {
            put(Database.TelemetryKeys.aggregate, aggregate.toString())
            put(Database.TelemetryKeys.groupBy, groupBy.toString())
            put(Database.TelemetryKeys.property, property.toString())
        }
    ) { span ->
    ...
    override suspend fun insert(models: Iterable<Model>): List<Model> = traced(
        ...
        span.enrich(TelemetryAttributes { put(Database.TelemetryKeys.insertCount, modelsList.size.toLong()) })
    ...
    override suspend fun replaceOne(
        ...
        span.enrich(TelemetryAttributes { put(Database.TelemetryKeys.replaced, if (result.old != null) 1L else 0L) })
        result
    }
    ...
    override suspend fun replaceOneIgnoringResult(
        ...
        span.enrich(TelemetryAttributes { put(Database.TelemetryKeys.replaced, if (result) 1L else 0L) })
        result
    }
    ...
    override suspend fun upsertOne(
        ...
        span.enrich(TelemetryAttributes { put(Database.TelemetryKeys.upserted, if (result.new != null) 1L else 0L) })
        span.enrich(TelemetryAttributes { put(Database.TelemetryKeys.wasInsert, if (result.old == null) 1L else 0L) })
        result
    }
    ...
    override suspend fun upsertOneIgnoringResult(
        ...
        span.enrich(TelemetryAttributes { put(Database.TelemetryKeys.wasUpdate, if (result) 1L else 0L) })
        result
    }
    ...
    override suspend fun updateOne(
        ...
        span.enrich(TelemetryAttributes { put(Database.TelemetryKeys.updated, if (result.old != null) 1L else 0L) })
        result
    }
    ...
    override suspend fun updateOneIgnoringResult(
        ...
        span.enrich(TelemetryAttributes { put(Database.TelemetryKeys.updated, if (result) 1L else 0L) })
        result
    }
    ...
    override suspend fun updateMany(
        ...
        span.enrich(TelemetryAttributes { put(Database.TelemetryKeys.updated, result.changes.size.toLong()) })
        result
    }
    ...
    override suspend fun updateManyIgnoringResult(
        ...
        span.enrich(TelemetryAttributes { put(Database.TelemetryKeys.updated, count.toLong()) })
        count
    }
    ...
    override suspend fun deleteOne(
        ...
        span.enrich(TelemetryAttributes { put(Database.TelemetryKeys.deleted, if (result != null) 1L else 0L) })
        result
    }
    ...
    override suspend fun deleteOneIgnoringOld(
        ...
        span.enrich(TelemetryAttributes { put(Database.TelemetryKeys.deleted, if (result) 1L else 0L) })
        result
    }
    ...
    override suspend fun deleteMany(condition: Condition<Model>): List<Model> = traced(
        ...
        span.enrich(TelemetryAttributes { put(Database.TelemetryKeys.deleted, result.size.toLong()) })
        result
    }
    ...
    override suspend fun deleteManyIgnoringOld(condition: Condition<Model>): Int = traced(
        ...
        span.enrich(TelemetryAttributes { put(Database.TelemetryKeys.deleted, count.toLong()) })
        count
    }
    ...
    override suspend fun findSimilar(
        ...
        val results = traced(
            ...
            extraBlock = {
                put(Database.TelemetryKeys.vectorField, vectorField.toString())
                put(Database.TelemetryKeys.metric, params.metric.toString())
                put(Database.TelemetryKeys.limit, params.limit.toLong())
                params.minScore?.let { put(Database.TelemetryKeys.minScore, it.toDouble()) }
            }
        ) { span ->
